<x-app-layout>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let lastNouveauCount = {{ $nouvellesDemandes }};
        const POLL_INTERVAL = 1800000; // 30 minutes
        ...
        function showNotification(count) {
            ...
            toast.innerHTML = `
                ...
                <div class="notification-body">
                    <strong>${count} nouvelle(s) demande(s)</strong>
                    <p>En attente de traitement (Nouveau)</p>
                </div>
        ...
        function pollStats() {
            ...
            .then(data => {
                ...
                if (data.nouveau > lastNouveauCount) {
                    showNotification(data.nouveau - lastNouveauCount);
                }
                lastNouveauCount = data.nouveau;
            })
            .catch(() => {});
        }
